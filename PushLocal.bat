...
c:\exe\nuget add .\Pythia.Api.Services\bin\Debug\Pythia.Api.Services.4.1.4.nupkg -source C:\Projects\_NuGet
...
c:\exe\nuget add .\Pythia.Sql\bin\Debug\Pythia.Sql.4.1.2.nupkg -source C:\Projects\_NuGet
c:\exe\nuget add .\Pythia.Sql.PgSql\bin\Debug\Pythia.Sql.PgSql.4.1.2.nupkg -source C:\Projects\_NuGet
