...
c:\exe\nuget add .\Pythia.Api.Services\bin\Debug\Pythia.Api.Services.5.1.3.nupkg -source C:\Projects\_NuGet
...
c:\exe\nuget add .\Pythia.Cli.Plugin.Standard\bin\Debug\Pythia.Cli.Plugin.Standard.5.1.2.nupkg -source C:\Projects\_NuGet
