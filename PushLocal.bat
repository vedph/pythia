...
c:\exe\nuget add .\Pythia.Api.Models\bin\Debug\Pythia.Api.Models.4.1.2.nupkg -source C:\Projects\_NuGet
c:\exe\nuget add .\Pythia.Api.Services\bin\Debug\Pythia.Api.Services.4.1.2.nupkg -source C:\Projects\_NuGet
