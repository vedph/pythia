...
namespace Corpus.Sql.MsSql.Test;
...
public sealed class MsSqlCorpusRepositoryTest : CorpusRepositoryTest
{
    private const string CST =
        "Server=127.0.0.1,1433;Database={0};User=sa;Password=P4ss-W0rd!;" +
    ...
    public MsSqlCorpusRepositoryTest()
    {
        _manager = new MsSqlDbManager(CST);
    }
    ...
    {
        MsSqlCorpusRepository repository = new();
