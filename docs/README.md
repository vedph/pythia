...
This solution, Pythia, provides a concordance-based, object-oriented text search engine.
...
The current Pythia implementation is based on PostgreSQL. Consequently, context-related functions are implemented in `PL/pgSQL`. Database schema and functions are defined in:
