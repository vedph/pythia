...
pause
%pt% index example-c c:\users\dfusi\desktop\pythia\*.xml -o -d pythia-demo -t pythia-factory-provider.chiron
pause
%pt% index-w -d pythia-demo -c date-value=3 -c date_value=3 -x date
pause
%pt% add-profiles c:\users\dfusi\desktop\pythia\example-c-prod.json -i example-c -d pythia-demo
pause
